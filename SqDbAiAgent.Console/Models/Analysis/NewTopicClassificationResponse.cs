...
public readonly record struct NewTopicClassificationResponse(bool IsNewTopic)
{
    ...
    public static bool TryParseFromJson(string json, out NewTopicClassificationResponse result)
    {
        try
        {
            ...
            result = new NewTopicClassificationResponse(valueElement.GetBoolean());
            return true;
        }
        catch (JsonException)
        {
