...
public readonly record struct MessageClassificationResponse(MessageKind Kind)
{
    ...
    public static bool TryParseFromJson(string json, out MessageClassificationResponse result)
    {
        try
        {
            ...
            result = new MessageClassificationResponse(kind);
            return true;
        }
        catch (JsonException)
        {
