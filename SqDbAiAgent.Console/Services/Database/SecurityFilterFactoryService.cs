...
public sealed class SecurityFilterFactoryService
{
    public bool HasSecurityProfile(string databaseName) =>
        string.Equals(databaseName, "HarborFlow", StringComparison.InvariantCultureIgnoreCase);
    ...
    {
        if (this.HasSecurityProfile(databaseName))
        {
